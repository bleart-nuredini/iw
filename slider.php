  ...
  <body>
    ...
    <div class="main">
      ...
      <div class="slider">
        ...
        <div class="slider-item invisible">
    ...
    <script>
      ...
      var numOfImages = 3; // number of images to be displayed in the slider
      var i = 0;
      ...
      function makeInvisible(number) {
        // change the image
        sliderElements[i].classList.remove('visible');
        sliderElements[i].classList.add('invisible');
        // change the text
      ...
      function makeVisible(i) {
        sliderElements[i].classList.remove('invisible');
        sliderElements[i].classList.add('visible');
